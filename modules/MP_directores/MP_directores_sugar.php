 ...
 * PLACE ANY CUSTOMIZATIONS IN MP_directores
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class MP_directores_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'MP_directores';
    public $object_name = 'MP_directores';
    public $table_name = 'mp_directores';
