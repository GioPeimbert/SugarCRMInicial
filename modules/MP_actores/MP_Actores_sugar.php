 ...
 * PLACE ANY CUSTOMIZATIONS IN MP_actores
 */

require_once 'include/SugarObjects/templates/person/Person.php';

class MP_actores_sugar extends Person {
    public $new_schema = true;
    public $module_dir = 'MP_actores';
    public $object_name = 'MP_actores';
    public $table_name = 'mp_actores';
